...
namespace ClothLearn
{
    ...
    public class ClothSimulator
    {
        ...
        private void BuildDistConstraints()
        {
            ...
            {
                this.AddDistanceConstraints(e.vIndex0, e.vIndex1);
            }
        }

        private void AddDistanceConstraints(int index0, int index1)
        {
            var restLength = math.distance(this.positions[index0], this._predictPositions[index1]);
        ...
        private JobHandle EstimatePositionJob(JobHandle depend, float dt)
        {
        ...
        {
            float di = (float)(1.0 / iterationCount);
            return 1.0f - math.pow(1.0f - stiffness, di);
        }
        ...
        private JobHandle StartDistanceConstraintsJob(JobHandle depend, int iterIndex)
        {
            ...
            float di =(float)(1.0 / (iteratorCount - iterIndex));
        ...
        public void Step(float dt)
        {
            ...
            handle = this.EstimatePositionJob(handle, dt);
